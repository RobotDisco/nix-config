...
*** Ripgrep support
    ...
    #+begin_src emacs-lisp :tangle yes
      ...
      (use-package helm-rg
        ...
        :after helm)
    #+end_src
** [Disabled] Perspective mode
*This is breaking helm for me for some reason, so disabling for now*
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     (use-package exwm
       ...
       (setq exwm-randr-workspace-monitor-plist
             '(1 "DP-1-1" 2 "DP-1-1" 3 "DP-1-2" 4 "DP-1-2"))
