...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package exwm-randr
    ...
    (setq exwm-randr-workspace-monitor-plist
	  '(0 "DP-4-1" 1 "DP-4-1" 2 "DP-4-2" 3 "DP-4-2"))
...
#+END_SRC
** File Management
I am most comfortable with orthodox file managers.

Sunrise Commander is like the old Norton Commander but in Emacs.
...
#+END_SRC
*** YAML
#+BEGIN_SRC emacs-lisp :tnagle yes
