...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package org-roam
    ...
    (org-roam-dailies-capture-templates
     '(("d" "default" entry
	"* %<%0H:%M> %?"
	:target (file+head+olp "%<%Y>/%<%0m>/%<%Y-%m-%d>.org" "#+STARTUP: fold\n#+TITLE: %<%Y-%0m-%0d, %A>" ("Log")))
       ("m" "Daily Morning Reflection" entry
	"* Daily Morning Reflection\n** What are my most important tasks today?\n- [ ] %?"
	:jump-to-captured t
	:prepend t
	:target (file+head "%<%Y>/%<%0m>/%<%Y-%0m-%0d>.org" "#+STARTUP: fold\n#+TITLE: %<%Y-%0m-%0d, %A>"))
	...
	:target (file+head "%<%Y>/%<%0m>/%<%0Y-%0m-%0d>.org" "#+STARTUP: fold\n#+TITLE: %<%Y-%0m-%0d, %A>")
	:unnarrowed t)
  ...
  The slipbox is defined as the top-level directory name relative to the value of org-roam-directory."
