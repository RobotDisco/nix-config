...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package org-jira
    ...
    (org-jira-custom-jqls
     '((:jql " project = CLOUD AND sprint in opensprints() AND (assignee = currentuser() OR assignee is EMPTY)" :filename "Sprint")
       (:jql " project = CLOUD AND type = epic" :filename "Epics")
       (:jql " project = CLOUD AND type IN (\"Service Request\", \"Access Request\") AND statusCategory != Done" :filename "Interrupts")
       (:jql " project = SI" :filename "ShapeUp")))
