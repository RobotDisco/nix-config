...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package org
    ...
    (org-agenda-files '("~/Documents/gtd/gtd.org"
  		      ...
  		      "~/Documents/gtd/jira/Interrupts.org"
  		      "~/Documents/gtd/jira/Sprint.org"))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package org-jira
    ...
    (org-jira-custom-jqls
     '((:jql " project = CLOUD AND sprint in opensprints() AND assignee = currentuser()" :filename "Sprint")
       (:jql " project = CLOUD AND type = epic" :filename "Epics")
       (:jql " project = CLOUD AND assignee = currentuser() AND type IN (\"Service Request\", \"Access Request\") AND statusCategory != Done" :filename "Interrupts")))
