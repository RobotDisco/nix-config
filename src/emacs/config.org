     ...
     (use-package smartparens
       :hook ((prog-mode . smartparens-global-mode)
              ...
              ((clojure-mode-hook
                ...
                ielm-mode-hook
                eval-expression-minibuffer-setup-hook) . turn-on-smartparens-strict-mode))
       :config
...
** Common Lisp
  ...
  (use-package slime-company
   ...
   #+END_SRC
** Emacs Lisp
   Emacs lisp doesn't have the nice buffer eval command of other lisp modes
   #+BEGIN_SRC emacs-lisp :tangle yes
