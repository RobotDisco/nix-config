...
**** Generic Lisp hook
     ...
     #+end_src
*** Common lisp
    SLIME, Emacs' Common Lisp environment, is installed via the QuickLisp package manager.

    We will load the package from its directory
...
*** Window title hook
    ...
    #+END_SRC
*** [Inactive since Xrandr 1.5] Monitor change hook
    **Note: This hasn't been needed since Xrandr 1.5 introduced the concept of pre-defined "monitors"**
...
*** Enable and configure EXWM
	...
	(require 'exwm-randr)
	;; This hook was used before XRandR 1.5 introduced the idea of pre-configured monitors
	;; out of laziness I have defined my monitor names to be the same as my laptop's output
	;; names for them but I could come up with more descriptive names if I so chose.
