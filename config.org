...
*** Window title hook
    ...
    #+BEGIN_SRC emacs-lisp :tangle yes
      (defun gaelan/exwm-buffer-title-hook ()
...
*** Enable and configure EXWM
    #+BEGIN_SRC emacs-lisp :tangle yes
      (use-package exwm
	:hook
	(exwm-update-class-hook . gaelan/exwm-buffer-title-hook)
	(exwm-randr-screen-change-hook . gaelan/exwm-randr-screen-change-hook)
	:init
